...
public class SmtpNotificadorDeLivroCadastrado implements NotificadorDeLivroCadastrado {

    private  SmtpEmailSettings cfg;

    public SmtpNotificadorDeLivroCadastrado(SmtpEmailSettings cfg) {
        this.cfg = cfg;
    }

    public SmtpNotificadorDeLivroCadastrado() {
